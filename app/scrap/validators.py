...
def converte_opcao_subopcao(opcao: str, subopcao: str) -> tuple[str, str]:
    ...
    dicionario_subopcoes = {
        '03': {'viniferas': '01', 'americanas e hibridas': '02', 'uvas de mesa': '03', 'sem classificacao': '04'},
        '05': {'vinhos de mesa': '01', 'espumantes': '02', 'uvas frescas': '03', 'uvas passas': '04', 'suco de uva': '05'},
        '06': {'vinhos de mesa': '01', 'espumantes': '02', 'uvas frescas': '03', 'suco de uva': '04'}
    }
...
def validar_parametros_entrada(ano: str, opcao: str, subopcao: str) -> None:
    ...
    if not validar_opcao(opcao):
        raise HTTPException(
            status_code=400,
            detail="Opção inválida. Use: Produção (02), Processamento (03), Comercialização (04), Importação (05), Exportação (06)."
        )

    if not validar_subopcao(opcao, subopcao):
        mensagens_erro_subopcao = {
            '03': "Subopção inválida para Processamento (03). Use: Viníferas (01), Americanas e Híbridas (02)...",
            '05': "Subopção inválida para Importação (05)...",
            '06': "Subopção inválida para Exportação (06)..."
        }
